            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="purchase-entry" autocomplete="off"><!-- Form Start -->
                        @csrf
                        <input type="hidden" name="p_id" id="p_id" class="party" value="{{$party->p_id}}">
                        <input type="hidden" name="p_e_b_otp" id="p_e_b_otp" value="{{$history->p_h_otp}}">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="billing-details" role="tabpanel">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control party search_name" id="p_name" placeholder="Name" name="p_name" value="{{$party->p_name}}" required disabled>
                                                <label for="p_name">Name <span class="text-danger">*</span></label>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control party" id="p_fmob" placeholder="Mob. No." name="p_fmob" value="{{$party->p_fmob}}" required disabled>
                                                <label for="p_fmob">Mob. No. <span class="text-danger">*</span></label>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control party" id="p_smob" placeholder="Alt. Mob. No." name="p_smob" value="{{$party->p_smob}}" disabled>
                                                <label for="p_smob">Alt. Mob. No.</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control party" id="p_gst" placeholder="G.S.T No." name="p_gst" value="{{$party->p_gst}}" disabled>
                                                <label for="p_gst">G.S.T No.</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-floating">
                                                <select class="form-select party state-select" id="p_state" placeholder="Select State" name="p_state" disabled>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control party p_address" id="p_add" placeholder="Address" name="p_add" value="{{$party->p_add}}" disabled>
                                                <label for="p_add">Address</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control party" id="p_desc" placeholder="Party Description" name="p_desc" value="{{$party->p_desc}}" disabled>
                                ...
                                <div class="mb-3 card p-2 ">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="p_h_bill_no" placeholder="Bill No." name="p_h_bill_no" value="{{$history->p_h_bill_no}}" disabled>
                                                <label for="p_h_bill_no">Bill No.</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="date" class="form-control" id="p_h_bill_date" placeholder="Bill Date" name="p_h_bill_date" value="{{$history->p_h_bill_date}}" onfocus="this.showPicker()" disabled>
                                                <label for="p_h_bill_date">Bill Date</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="p_h_veh_no" placeholder="Vehicle No." name="p_h_veh_no" value="{{$history->p_h_veh_no}}">
                                                <label for="p_h_veh_no">Vehicle No.</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="date" class="form-control" id="p_h_del_date" placeholder="Delivery Date" name="p_h_del_date" value="{{$history->p_h_del_date}}" onfocus="this.showPicker()">
                                                <label for="p_h_del_date">Delivery Date</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="p_h_other" placeholder="Other Charge" name="p_h_other" value="{{$history->p_h_other}}">
                                                <label for="p_h_other">Other Charge</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control party" name="p_h_pre" id="p_h_pre" placeholder="Pre Dues" value="{{$history->p_h_pre}}" readonly />
                                                <label for="p_h_pre">Pre Dues</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="p_h_total" name="p_h_total" placeholder="Inv. Total" value="{{$history->p_h_total}}" readonly />
                                                <label for="p_h_total">Inv. Total</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="p_h_dis" placeholder="Discount" name="p_h_dis" value="{{$history->p_h_dis}}" />
                                                <label for="p_h_dis">Discount</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="p_h_grand" name="p_h_grand" placeholder="Grand Total" value="{{$history->p_h_grand}}" readonly />
                                                <label for="p_h_grand">Grand Total</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="p_h_paid" placeholder="Paid Amt." name="p_h_paid" value="{{$history->p_h_paid}}" />
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="p_h_dues" placeholder="Dues Amt." readonly name="p_h_dues" value="{{$history->p_h_dues}}" />
                            ...
                            <div class="tab-pane active" id="item-details" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div id="save_and_new" data-p_h_id="0" data-role="1" class="btn btn-primary rounded-pill submit_btn">Save &
                                                New</div>
                    ...
                    <div class="container-fluid">
                        <table class="table table-bordered dt-responsive nowrap align-middle" id="purchase_history_table" style="display: none;">
                            ...
                            <tbody id="purchase_history_list">
                                ...
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$pItem['item_name']}}</td>
                                    <td>{{$pItem['p_i_qty']}}</td>
                                    <td>{{$pItem['p_i_rate']}}</td>
                                    <td>{{$pItem['p_i_total']}}</td>
                                    <td>
                                        <div class="btn btn-success edit-btn" data="{{$pItem['p_i_id']}}" data-p_h_id="{{$pItem['p_i_id']}}" data-edit="0">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="btn btn-danger delete-btn" data="{{$pItem['p_i_id']}}" data-p_h_id="{{$pItem['p_i_id']}}">
                ...
                <div class="px-4 w-100 position-absolute" id="partytable" style="margin-top:160px;display:none">
...
<script>
    $(document).ready(function() {
        ...
        // $('#pe_link').addClass('active');
        pageSetup();
        console.clear();
        let invTotals = $('#p_h_total').val();
        let previousDues = 0;
        let flag = 1;
        let previousItemID = 0;
        let newItemID = 0;
        let previousHistoryID = "{{$history->p_h_id}}";
