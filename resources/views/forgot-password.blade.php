...
<head>
    ...
    <meta charset="utf-8" />
    <title>Reset Password | SpecBits Billing Software</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="SpecBits Multipurpose Admin & Dashboard Template" name="description" />
                            ...
                            <div class="row justify-content-center g-0">
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 auth-one-bg h-100">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a class="d-block">
                                                    <h4 class="text-white fw-bold">Billing</h4>
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <p class="text-muted">Reset password with Billing</p>
                                        ...
                                        <div class="p-2">
                                            <form>
                                                ...
                                                <div class="text-center mt-4">
                                                    <button class="btn btn-success w-100" type="submit">Send
                                                        Otp</button>
                                                </div>
                                            </form><!-- end form -->
                                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                ...
                                </script> Billing. Crafted with <i class="mdi mdi-heart text-danger"></i>
                                by SpecBits
                            </p>
                        </div>
                    </div>
